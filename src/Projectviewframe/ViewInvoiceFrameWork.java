...
import ProjectController.ProjectController;
...
public class ViewInvoiceFrameWork extends javax.swing.JFrame {

    /**
     * Creates new form InvoiceFrame
     */
    public ViewInvoiceFrameWork() {
        this.getContentPane();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewInvoiceFrameWork.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewInvoiceFrameWork().setVisible(true);
            }
        });
    }
    ...
    private ProjectController controller = new ProjectController(this);
    private ModelInvoicesTable invoicesTableModel;

    public ArrayList<ModelInvoice> getInvoices() {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoices(ArrayList<ModelInvoice> invoices) {
        this.invoices = invoices;
    }

    public ModelInvoicesTable getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new ModelInvoicesTable(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(ModelInvoicesTable invoicesTableModel) {
    ...
    public int getNextInvoiceNum() {
        ...
        for (ModelInvoice invoice : getInvoices()) {
